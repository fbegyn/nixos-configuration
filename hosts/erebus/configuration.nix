{config, pkgs, ... }:
{
  ...
  home-manager.users.francis = {
    ...
    emacs.emacsPackage = pkgs.unstable.emacs29-gtk3.overrideAttrs (old: {
      patches = (old.patches or []) ++ [
        ...
        # TODO: poll patch removed from upstream, follow up on it
        # https://github.com/d12frosted/homebrew-emacs-plus/pull/746
        # (pkgs.fetchpatch {
